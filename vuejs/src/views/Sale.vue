<template>
  <div>
    <v-card>
                ...
                <v-card-text style="height: 300px">
                  <v-radio-group v-model="category" column>
                    ...
                    <v-radio
                      ...
                      value="가구/인테리어"
                    ></v-radio>
                    <v-radio label="스포츠/레저" value="스포츠/레저"></v-radio>
      ...
      <v-btn color="green darken-1" @click="asd"> 네 </v-btn>
      <!-- </v-form> -->
    </v-card>
  </div>
</template>
